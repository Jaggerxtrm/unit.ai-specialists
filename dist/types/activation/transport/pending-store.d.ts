 ...
 */
export type WireDeliveryState = 'pending' | 'sent_unconfirmed' | 'delivered' | 'refused' | 'undeliverable';
 ...
 */
export declare function projectDeliveryState(state: WireDeliveryState): SharedDeliveryState;
export declare function createsPendingAsk(kind: string): boolean;
...
export declare function interactionsRoot(repoRoot: string): string;
/**
 ...
 */
export declare function create(repoRoot: string, input: {
    messageId: string;
    activationId: string;
    kind: InteractionKind;
    message: InteractionPayload;
...
export declare function read(repoRoot: string, activationId: string, messageId: string): PendingInteraction | undefined;
export declare function readReply(repoRoot: string, activationId: string, messageId: string): InteractionReply | undefined;
/**
 ...
 */
export declare function recordAttempt(repoRoot: string, activationId: string, messageId: string, attempt: DeliveryAttempt): PendingInteraction;
/**
 ...
 */
export declare function recordReceipt(repoRoot: string, activationId: string, messageId: string, receipt: {
    origMsgId: string;
    receiptMsgId?: string;
    atMs?: number;
}): PendingInteraction;
...
export declare function listAll(repoRoot: string): PendingInteractionView[];
